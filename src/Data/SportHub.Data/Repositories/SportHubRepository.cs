...
public class SportHubRepository<TEntity> : IRepository<TEntity>, IDeletableEntityRepository<TEntity>
    where TEntity : class, IDeletableEntity
{
    public SportHubRepository(SportHubDbContext context)
    {
        this.Context = context;
        this.DbSet = this.Context.Set<TEntity>();
    }

    protected SportHubDbContext Context { get; }
