...
public class CoachesConverter : BaseConverter
{
    private readonly OlympicGamesRepository<Person> repository;

    public CoachesConverter(ILogger<BaseConverter> logger, ICrawlersService crawlersService, ILogsService logsService, IGroupsService groupsService, IZipService zipService,
