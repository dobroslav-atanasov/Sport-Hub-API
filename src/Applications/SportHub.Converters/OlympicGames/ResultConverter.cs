    ...
    protected override async Task ProcessGroupAsync(Group group)
    {
        try
        {
            ...
            if (eventModel != null)
            {
                ...
                if (eventCache != null)
                {
                    var roundDataModels = this.ExtractRoundDataModels(htmlDocument, eventCache);
                    var documentDataModels = this.ExtractDocumentDataModels(documents, eventCache);
