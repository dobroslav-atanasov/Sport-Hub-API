...
public class DisciplinesCrawler : BaseCrawler
{
    public DisciplinesCrawler(ILogger<BaseCrawler> logger, IConfiguration configuration, IHttpService httpService, ICrawlersService crawlersService, IGroupsService groupsService)
