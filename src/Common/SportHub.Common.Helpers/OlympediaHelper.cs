...
{
    public static List<int> FindClubs(string text)
    {
    ...
    public static AthleteModel FindAthlete(string text)
    {
        if (!string.IsNullOrEmpty(text))
        {
            var match = RegExpHelper.Match(text, @"<a href=""\/athletes\/(\d+)"">(.*?)<\/a>");
            if (match != null)
            {
    ...
    public static List<AthleteModel> FindAthletes(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return [];
    ...
    public static string FindNOCCode(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return null;
        ...
        var match = RegExpHelper.Match(text, @"<a href=""\/countries\/(.*?)"">");
        if (match != null)
        {
    ...
    public static IList<string> FindNOCCodes(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
    ...
    public static MedalEnum FindMedal(string text)
    {
        var match = RegExpHelper.Match(text, @"<span class=""(?:Gold|Silver|Bronze)"">(Gold|Silver|Bronze)<\/span>");
        if (match != null)
        {
    ...
    public static MedalEnum FindMedal(string text, RoundEnum roundType)
    {
    ...
    public static FinishStatusEnum FindFinishStatus(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
        ...
        var acMatch = RegExpHelper.Match(text, @"<abbrev title=""Also Competed"">AC</abbrev>");
        if (acMatch != null)
        {
            return FinishStatusEnum.AlsoCompeted;
        }

        var dnsMatch = RegExpHelper.Match(text, @"<abbrev title=""Did Not Start"">DNS</abbrev>");
        if (dnsMatch != null)
        {
            return FinishStatusEnum.DidNotStart;
        }

        var dnfMatch = RegExpHelper.Match(text, @"<abbrev title=""Did Not Finish"">DNF</abbrev>");
        if (dnfMatch != null)
        {
            return FinishStatusEnum.DidNotFinish;
        }

        var dqMatch = RegExpHelper.Match(text, @"<abbrev title=""Disqualified"">DQ</abbrev>");
        if (dqMatch != null)
        {
            return FinishStatusEnum.Disqualified;
        }

        var tnkMatch = RegExpHelper.Match(text, @"<abbrev title=""Time Not Known"">TNK</abbrev>");
        if (tnkMatch != null)
        {
    ...
    public static List<int> FindVenues(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return [];
    ...
    public static int FindMatchNumber(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return 0;
        ...
        var match = RegExpHelper.Match(text, @"(?:Match|Game|Race)\s*#(\d+)");
        if (match != null)
        {
    ...
    public static int FindResultNumber(string text)
    {
        var match = RegExpHelper.Match(text, @"<a href=""\/results\/(\d+)"">");
        if (match != null)
        {
    ...
    public static string FindLocation(string html)
    {
        ...
        var match = RegExpHelper.Match(html, @"<a href=""\/venues\/(\d+)"">(.*?)<\/a>");
        if (match != null)
        {
    ...
    public static string FindMatchInfo(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return null;
        ...
        var match = RegExpHelper.Match(text, @"(?:Match|Game)\s*(\d+)(?:\/|-)(\d+)");
        if (match != null)
        {
    ...
    public static RecordEnum FindRecord(string text)
    {
        ...
        var match = RegExpHelper.Match(text, @"World\s*Record");
        if (match != null)
        {
            record = RecordEnum.World;
        }

        match = RegExpHelper.Match(text, @"Olympic\s*Record");
        if (match != null)
        {
    ...
    public static bool IsQualified(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return false;
        ...
        var match = RegExpHelper.Match(text, @"Qualified");
        if (match != null)
        {
            isQualified = true;
        }
    ...
    public static IList<int> FindResults(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return new List<int>();
    ...
    public static DecisionEnum FindDecision(string text)
    {
        ...
        var match = RegExpHelper.Match(text, @">bye<");
        if (match != null)
        {
            decision = DecisionEnum.Buy;
        }

        match = RegExpHelper.Match(text, @">walkover<");
        if (match != null)
        {
    ...
    public static int FindSeedNumber(string text)
    {
        if (string.IsNullOrEmpty(text))
        {
            return 0;
        ...
        var match = RegExpHelper.Match(text, @"\((\d+)\)");
        if (match != null)
        {
            return int.Parse(match.Groups[1].Value);
        }
    ...
    public static Horse FindHorse(string text)
    {
        if (!string.IsNullOrEmpty(text))
        {
            var match = RegExpHelper.Match(text, @"<a href=""/horses/(\d+)"">(.*?)</a>");
            if (match != null)
            {
                return new Horse
                {
    ...
    public static Dictionary<string, int> GetIndexes(List<string> headers)
    {
    ...
    public static Dictionary<string, int> FindIndexes(List<string> headers)
    {
        var indexes = new Dictionary<string, int>();
